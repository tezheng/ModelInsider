...
class TestModelAutoDetection:
    ...
    @patch('modelexport.core.model_input_generator.generate_dummy_inputs_from_model_path')
    ...
    def test_auto_generation_task_detection_failure(self, mock_generate_from_model):
        ...
        mock_generate_from_model.side_effect = ValueError("Could not create export config")
...
class TestLegacyCompatibility:
    ...
    def test_legacy_function_calls_unified(self, mock_get_config):
        ...
        mock_config.generate_dummy_inputs.return_value = {"input_ids": torch.randint(0, 1000, (1, 128))}
