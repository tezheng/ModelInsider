...
class TestGraphMLToONNXImport:
    ...
    def test_conversion_info_extraction(self, sample_onnx_model_with_metadata, tmp_path):
...
class TestRoundTripValidation:
    ...
    def test_round_trip_validation_structure(self, sample_onnx_model_with_metadata, tmp_path):
...
class TestFileIntegrity:
    ...
    def test_parameter_file_checksum(self, sample_onnx_model_with_metadata, tmp_path):
        ...
        checksum_elem = None
        for data in root.findall(".//{http://graphml.graphdrawing.org/xmlns}data[@key='p2']"):
            checksum_elem = data
            break
    ...
    def test_size_preservation_accuracy(self, sample_onnx_model_with_metadata, tmp_path):
