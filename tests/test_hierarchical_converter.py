...
Tests the ONNXToGraphMLConverter class functionality for creating
...
class TestONNXToGraphMLConverter:
    """Test ONNXToGraphMLConverter functionality."""
    ...
    def test_init_with_valid_metadata(self, hierarchical_htp_metadata):
        ...
        converter = ONNXToGraphMLConverter(
            htp_metadata_path=str(hierarchical_htp_metadata),
    ...
    def test_init_with_missing_metadata(self, tmp_path):
        ...
        with pytest.raises(FileNotFoundError):
            ONNXToGraphMLConverter(htp_metadata_path=str(missing_path))
    ...
    def test_deep_hierarchy(self, sample_onnx_model, deep_hierarchy_metadata):
        ...
        converter = ONNXToGraphMLConverter(
            htp_metadata_path=str(deep_hierarchy_metadata),
            exclude_initializers=True
        )
