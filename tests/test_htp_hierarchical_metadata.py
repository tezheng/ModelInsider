...
class TestHierarchicalMetadata:
    ...
    def schema(self):
        ...
        schema_path = (
            ...
            / "modelexport/strategies/htp/htp_metadata_schema.json"
        )
    ...
    def sample_flat_hierarchy(self):
        ...
        return {
            "": ModuleInfo(
                class_name="BertModel", traced_tag="/BertModel", execution_order=0
            ),
    ...
    def test_schema_validation(self, schema, sample_flat_hierarchy):
        ...
        builder.with_export_context(export_time_seconds=1.0)
        builder._export_context.timestamp = (
            "2025-07-22T12:00:00Z"  # Set timestamp manually for test
        )
        ...
        builder.with_output_files(
            onnx_path="test.onnx", onnx_size_mb=10.0, metadata_path="test_metadata.json"
        )
        ...
        builder.with_export_report(
            ...
            steps={
                ...
                "tag_injection": {"tags_injected": True, "tags_stripped": False},
            },
    ...
    def test_single_module_hierarchy(self):
        ...
        flat = {
            "": ModuleInfo(
                class_name="SimpleModel", traced_tag="/SimpleModel", execution_order=0
            )
        }
