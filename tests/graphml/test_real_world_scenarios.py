...
class TestProductionScenarios:
    ...
    def test_vision_model_conversion(self, tmp_path):
        ...
        assert 'BatchNormalization' in graphml_str or 'BatchNorm' in graphml_str or 'Add' in graphml_str
...
class TestStressAndScale:
    ...
    def test_wide_model(self, tmp_path):
        ...
        assert len(graphml_str) < 1000000, "GraphML too large, might include initializers"
    ...
    def test_concurrent_conversions(self, tmp_path):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=4) as executor:
            futures = [executor.submit(convert_model, path_info) for path_info in onnx_paths]
