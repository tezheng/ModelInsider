...
'''
    ...
    # Save the file
    output_path = Path("/home/zhengte/modelexport_allmodels/experiments/export_monitor/export_monitor_v3.py")
    with open(output_path, 'w') as f:
        f.write(code)
    
    print(f"✅ Created export_monitor_v3.py at {output_path}")
    return output_path

def main():
    """Main script."""
    print("🔧 CREATING EXPORT MONITOR V3")
    print("=" * 60)
    
    # Create v3
    v3_path = create_export_monitor_v3()
    
    print("\n📝 Key fixes in V3:")
    print("1. Fixed metadata writer to use export_time correctly")
    print("2. Fixed console output to match baseline formatting")
    print("3. Fixed hierarchy tree display")
    print("4. Fixed node operation grouping")
    print("5. Cleaned up code structure")
