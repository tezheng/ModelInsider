...
class HTPExportMonitor:
    ...
    def _print_hierarchy_tree(self, hierarchy: dict) -> None:
        ...
        # Print tree
        def print_tree(path: str, prefix: str = "", line_count: list | None = None):
    ...
    def onnx_export(self, opset_version: int = 17, do_constant_folding: bool = True,
                   input_names: list | None = None) -> None:
        """Step 4: ONNX export."""
    ...
    # Final summary
    def complete(self, export_time: float | None = None) -> None:
    ...
    def _print_hierarchy_with_nodes(self) -> None:
        ...
        def print_module_nodes(path: str, level: int = 1, prefix: str = "", line_count: list | None = None):
            if line_count is None:
                line_count = [1]
