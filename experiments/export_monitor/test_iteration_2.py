...
def capture_export_with_v2_monitor():
    ...
    # Create a console that captures output with colors
    buffer = io.StringIO()
    ...
    with monitor:
        ...
        # Step 6: Node tagging (sample data)
        tagged_nodes = {}
    ...
    console_path = output_dir / "console_output.txt"
...
def compare_with_baseline():
    ...
    baseline_clean = baseline.replace("temp/baseline", "experiments/export_monitor/iterations/iteration_002")
    ...
    # Save diff
    diff_path = Path("/home/zhengte/modelexport_allmodels/experiments/export_monitor/iterations/iteration_002/console_diff.txt")
...
def main():
    ...
    print("🔧 Testing Iteration 2 - Refactored Export Monitor")
    print("=" * 60)
